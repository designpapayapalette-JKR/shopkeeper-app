...
function PaperWidthPicker({ pendingPaperWidth, setPendingPaperWidth }: { pendingPaperWidth: PaperWidth; setPendingPaperWidth: (w: PaperWidth) => void }) {
 ...
 >
 <Text className={`text-sm font-bold ${pendingPaperWidth === w ? "text-white" : "text-on-surface "}`}>
 {w}mm
 </Text>
 </Pressable>
 ))}
...
export default function PrinterSettingsScreen() {
 ...
 <Text className="text-sm font-bold text-on-surface-variant uppercase tracking-widest">
 Saved Printers
 </Text>
 {printers.map((p) => (
 <View
 ...
 p.isDefault ? "bg-primary/10 border-primary/20" : "bg-surface-container-lowest border-outline-variant "
 }`}
 >
 ...
 <Text className="text-sm text-on-surface-variant uppercase mt-0.5">
 ...
 <Text className="text-sm font-bold text-on-surface-variant uppercase tracking-widest mb-3">
 Add a Printer
 </Text>
 ...
 disabled={scanning}
 className="bg-surface-container-lowest border border-outline-variant rounded-xl py-3.5 items-center mb-4"
 >
 ...
 >
 <View>
 <Text className="font-bold text-on-surface ">{d.device_name || "Unnamed Printer"}</Text>
 <Text className="text-sm text-on-surface-variant ">{d.inner_mac_address}</Text>
 </View>
 ...
 >
 <View>
 <Text className="font-bold text-on-surface ">{d.device_name || "USB Printer"}</Text>
 <Text className="text-sm text-on-surface-variant ">Vendor {d.vendor_id} · Product {d.product_id}</Text>
 </View>
