...
export default function AccountSecurityScreen() {
 ...
 <Text className="text-base font-bold text-on-surface ">{me.email}</Text>
 {me.email_verified ? (
 ...
 <Text className="text-xs text-on-surface-variant mt-1">Not verified yet.</Text>
 )}
 </View>
 </View>
 {!me.email_verified && (
 <Pressable onPress={handleResendVerification} disabled={sendingVerify} className="py-2 px-3 rounded-lg bg-background border border-outline-variant ">
 ...
 secureTextEntry
 autoCapitalize="none"
 className="bg-background text-on-surface border border-outline-variant rounded-xl px-4 py-3 text-base font-medium mb-3"
 />
 ...
 >
 <Text className="text-on-surface-variant font-bold text-sm">Cancel</Text>
 </Pressable>
 <Pressable
