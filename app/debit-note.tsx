  ...
  if (result) {
    return (
      <View className="flex-1 items-center justify-center bg-background dark:bg-bg-dark px-8" style={{ paddingTop: topInset }}>
        ...
        <Text className="text-xl font-black text-text-primary dark:text-text-primary-dark mt-3">Debit Note Created</Text>
  ...
  return (
    <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <ScrollView className="flex-1 bg-background dark:bg-bg-dark px-6" style={{ paddingTop: topInset }} keyboardShouldPersistTaps="handled">
        <Text className="text-2xl font-black text-text-primary dark:text-text-primary-dark mb-1">Debit Note</Text>
        ...
        {purchase && (
          <>
            <Text className="text-sm text-text-secondary mb-2">
              Supplier: <Text className="font-bold text-text-primary dark:text-text-primary-dark">{purchase.supplier?.name || "—"}</Text>
            </Text>
            ...
            {activeLines.length > 0 && (
              <View className="flex-row justify-between items-center py-3 border-t border-gray-100 dark:border-zinc-800 mb-4">
                <Text className="text-base font-bold text-text-primary dark:text-text-primary-dark">Debit Amount</Text>
