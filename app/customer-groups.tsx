...
export default function CustomerGroupsScreen() {
 ...
 <Text className="text-xl font-bold text-on-surface ">Customer Groups</Text>
 </View>
 ...
 <Text className="text-xl font-bold text-on-surface ">{activeGroup?.name}</Text>
 </View>
 ...
 <Text className="text-sm font-bold text-on-surface-variant ">No members yet</Text>
 </View>
 ) : (
 ...
 renderItem={({ item }) => (
 <View className="bg-surface-container-lowest p-4 rounded-2xl border border-outline-variant mb-2 flex-row items-center">
 <View className="flex-1">
 <Text className="text-sm font-bold text-on-surface ">{item.party.name}</Text>
 {item.party.phone && <Text className="text-xs text-on-surface-variant ">{item.party.phone}</Text>}
 </View>
 ...
 <View className="flex-1 bg-background " style={{ paddingTop: topInset }}>
 <View className="flex-row items-center justify-between px-6 py-4">
 <Text className="text-xl font-bold text-on-surface ">Add Member</Text>
 ...
 className={`px-3.5 py-2.5 rounded-xl border ${selectedPartyId === p.id ? "bg-primary border-primary" : "bg-surface-container-lowest border-outline-variant "}`}>
 <Text className={`text-sm font-bold ${selectedPartyId === p.id ? "text-white" : "text-on-surface-variant "}`}>{p.name}</Text>
 </Pressable>
 ))}
 </View>
 </ScrollView>
