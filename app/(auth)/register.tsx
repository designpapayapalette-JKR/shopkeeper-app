        ...
        <View className="px-6 py-12 justify-center flex-1 max-w-md mx-auto w-full">
          <View className="items-center mb-8">
            ...
            <Text className="text-text-secondary dark:text-text-secondary-dark text-center mt-2 font-medium">
              Shopkeeper is invite-only during beta — enter your invite code below.
            </Text>
          </View>
          ...
          <View className="bg-surface dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-xl">
            ...
            <Pressable onPress={() => router.replace("/(auth)/login")} className="mt-6 py-3 items-center">
              <Text className="text-primary dark:text-primary-dark font-semibold text-base">Already have an account? Log In</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
