          ...
          <View className="bg-surface dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-xl">
            {sent ? (
              <>
                ...
                <Text className="text-text-secondary dark:text-text-secondary-dark text-sm font-medium mb-6">
                ...
                <Pressable
                  onPress={() => router.back()}
                  className="bg-primary dark:bg-primary-dark py-5 rounded-xl items-center active:opacity-90 shadow-md"
              ...
              <>
                ...
                <Pressable onPress={() => router.back()} className="mt-4 py-3 items-center" accessibilityRole="button" accessibilityLabel="Back to log in">
                  <Text className="text-primary dark:text-primary-dark font-semibold text-base">Back to Log In</Text>
                </Pressable>
              </>
            )}
          </View>
