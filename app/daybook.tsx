...
import { Card, useTheme, Button, SegmentedButtons } from "react-native-paper";
          ...
          <View className="px-4 mb-4" style={{ gap: 8 }}>
            <View className="flex-row" style={{ gap: 8 }}>
              {summaryItems.slice(0, 3).map((item) => (
                <Card key={item.label} mode="elevated" className="flex-1">
            ...
            <>
              {(data?.invoices || []).length === 0 ? (
                ...
                (data?.invoices || []).map((inv: any) => (
                  <Card key={inv.id} mode="elevated" className="mb-2">
            ...
            <>
              {(data?.payments || []).length === 0 ? (
                ...
                (data?.payments || []).map((pmt: any) => (
                  <Card key={pmt.id} mode="elevated" className="mb-2">
                    <Card.Content className="flex-row items-center justify-between">
                      <View className="flex-row items-center" style={{ gap: 8 }}>
            ...
            <>
              {(data?.expenses || []).length === 0 ? (
                ...
                (data?.expenses || []).map((exp: any) => (
                  <Card key={exp.id} mode="elevated" className="mb-2">
                    <Card.Content className="flex-row items-center justify-between">
                      <View>
