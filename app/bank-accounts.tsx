...
export default function BankAccountsScreen() {
 ...
 <View
 className="bg-surface-container-lowest border-b border-outline-variant px-margin-mobile pb-3 flex-row justify-between items-center"
 ...
 className="bg-surface-container-lowest border border-outline-variant px-3 py-2.5 rounded-xl items-center justify-center"
 >
 ...
 renderItem={({ item }) => (
 <View className="bg-surface-container-lowest p-4 rounded-2xl border border-outline-variant shadow-sm flex-row justify-between items-center">
 ...
 <Pressable onPress={handleAdd} disabled={submitting} className="bg-primary py-4 rounded-xl items-center" style={{ marginBottom: bottomInset }}>
