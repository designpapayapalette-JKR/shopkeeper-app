...
// The app is light-theme only. All screens have had their `dark:` Tailwind
// classes removed in a batch cleanup. Locking the scheme here overrides
// NativeWind's "media" (system) mode app-wide.
