...
export default function ScannedDocumentsScreen() {
 ...
 <Text className="text-xl font-bold text-on-surface ">Scanned Documents</Text>
 </View>
 ...
 className="flex-1 bg-surface-container-lowest rounded-2xl border border-outline-variant overflow-hidden"
 >
 <Image source={{ uri: item.uri }} style={{ width: "100%", height: 130 }} resizeMode="cover" />
 <View className="px-3 py-2">
 <Text className="text-sm font-bold text-on-surface capitalize" numberOfLines={1}>
 {item.category}
 </Text>
