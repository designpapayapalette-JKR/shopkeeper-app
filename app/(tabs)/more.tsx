...
export default function MoreScreen() {
 ...
 const { user, userRole, activeCompany, refreshCompany, setupQuickPin, pinLoginAvailable, logout } = useAuth();
 ...
 <Text className="text-sm font-black text-primary uppercase tracking-widest mb-3">
 Operations
 </Text>

 {/* Billing & Sales — daily counter and wholesale billing */}
 {(isModuleEnabled("pos") || isModuleEnabled("b2b")) && (
   ...
   {isModuleEnabled("b2b") && (
    <>
     ...
     <Pressable onPress={() => router.push("/b2b" as any)} className="flex-row justify-between items-center py-2.5">
      <Text className="text-base font-bold text-on-surface flex-1 mr-2">New B2B Sale / Estimate</Text>
      <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
     </Pressable>
    </>
   )}
 ...
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Record Purchase</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Bank Reconciliation</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Financial Year Closing</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Customer Groups</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Price Lists</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Invoice Templates</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Scanned Documents Archive</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Activity Log</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Bank Accounts</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">GST Rate Tools</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Bulk Price Update</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 ...
 className="flex-row justify-between items-center py-2.5"
 >
 <Text className="text-base font-bold text-on-surface flex-1 mr-2">Reorder Suggestions</Text>
 <MaterialCommunityIcons name="chevron-right" size={20} color={theme.colors.primary} />
 </Pressable>
 </View>
 ...
 selectedSupplierId === s.id ? "text-white" : "text-on-surface-variant "
 }`}
 >
 {s.name}
 </Text>
 ...
 <Text
 className={`text-sm font-semibold ${
 selectedProductId === p.id ? "text-white" : "text-on-surface-variant "
 }`}
 >
 {p.name}
 </Text>
 ...
 selectedWarehouseId === w.id ? "text-white" : "text-on-surface "
 }`}
 >
 {w.name}
 </Text>
 ...
 purchaseQtyMode === "unit" ? "bg-primary border-primary " : "border-gray-200 "
 }`}
 >
 <Text className={`text-sm font-bold ${purchaseQtyMode === "unit" ? "text-white" : "text-on-surface-variant "}`}>
 By {baseUnit}
 </Text>
 </Pressable>
 <Pressable
 ...
 className={`flex-1 py-2 rounded-lg items-center border ${
 purchaseQtyMode === "pack" ? "bg-primary border-primary " : "border-gray-200 "
 }`}
 >
 <Text className={`text-sm font-bold ${purchaseQtyMode === "pack" ? "text-white" : "text-on-surface-variant "}`}>
 By {packUnit}
 </Text>
 </Pressable>
 </View>
 ...
 <Pressable
 onPress={closePurchaseModal}
 className="border border-gray-200 py-4 px-6 rounded-xl w-[48%] items-center"
 >
 ...
 <Text className="text-on-surface-variant text-xs mt-0.5">Optional — helps during approval</Text>
 </Pressable>
 )}
 ...
 <Text
 className={`text-sm font-semibold ${
 transferProductId === p.id ? "text-white" : "text-on-surface-variant "
 }`}
 >
 {p.name}
 </Text>
 ...
 <Text
 className={`text-sm font-bold ${
 transferSourceWhId === w.id ? "text-white" : "text-on-surface "
 }`}
 >
 {w.name}
 </Text>
 ...
 <Text
 className={`text-sm font-bold ${
 transferDestWhId === w.id ? "text-white" : "text-on-surface "
 }`}
 >
 {w.name}
 </Text>
 ...
 <Text className="text-primary font-bold text-sm">Attach Receipt Photo</Text>
 </Pressable>
 )}
 </View>
 ...
 <Text className="text-on-surface-variant font-bold text-center">No employee profiles found</Text>
 </View>
 ) : (
 ...
 <View
 key={s.id}
 className="bg-surface p-4 rounded-2xl border border-gray-100 mb-4 shadow-sm"
 >
 <Text className="font-bold text-sm text-on-surface ">
 {s.first_name} {s.last_name || ""}
 </Text>
 <Text className="text-sm text-on-surface-variant mt-0.5 font-semibold">
 Email: {s.email}
 </Text>
 ...
 currentStatus === statusOption ? "text-white" : "text-on-surface-variant "
 }`}
 >
 ...
 <Text
 className={`text-sm font-semibold ${
 selectedStaffId === s.id ? "text-white" : "text-on-surface-variant "
 }`}
 >
 {s.first_name}
 </Text>
 ...
 <Text className="text-sm font-bold text-on-surface-variant mt-1 uppercase tracking-wider">
 {item.status}
 </Text>
 </View>
 </View>
 ...
 className="bg-primary py-4 rounded-xl items-center mb-6 shadow-sm"
 >
 ...
 <View className="flex-grow justify-center items-center py-20">
 <Text className="text-on-surface-variant font-bold text-center">No challans generated</Text>
 </View>
 ) : (
 <FlatList
 data={challans}
 ...
 if (item.status === "in_transit") badgeColor = "bg-orange-50 text-orange-600 ";
 ...
 <Text className="text-sm text-on-surface-variant mt-1 font-semibold" numberOfLines={1}>
 ...
 <Text
 className={`text-sm font-semibold ${
 selectedInvoiceId === inv.id ? "text-white" : "text-on-surface-variant "
 }`}
 >
 {inv.invoice_number}
 </Text>
 ...
 <View key={item.productId} className="flex-row items-center justify-between py-2 border-b border-gray-100 ">
 <Text className="flex-1 mr-2 text-sm font-semibold text-on-surface " numberOfLines={1}>{item.name}</Text>
 <TextInput
 value={item.quantity}
 onChangeText={(v) => updateChallanItemQty(item.productId, v)}
 keyboardType="numeric"
 className="bg-background border border-gray-200 rounded-lg px-3 py-2 text-sm font-bold w-16 text-center mr-2"
 />
 ...
 <Text className="text-sm text-on-surface-variant mt-0.5 font-medium">
 ...
 <Text className="text-3xl font-black text-on-surface mt-1.5">
 ...
 <Text className="text-on-surface-variant font-bold text-center">No products registered</Text>
 </View>
 ) : (
 <FlatList
 data={products}
 ...
 <Text className="font-bold text-sm text-on-surface mb-2">
 ...
 <Text className="text-sm text-on-surface-variant mt-0.5" numberOfLines={1}>Phone: {p.phone || "N/A"}</Text>
 </View>
 <View className="flex-row items-center space-x-2">
 <Pressable
 ...
 <Text className="font-bold text-sm text-on-surface mt-6 mb-2">
 ...
 <View className="flex-1 justify-center items-center py-20">
 <Text className="text-on-surface-variant font-bold text-center">No movements recorded</Text>
 </View>
 ) : (
 <FlatList
 data={movements}
 ...
 let indicatorColor = "text-blue-600 bg-blue-50 ";
 if (isPurchase || (isTransfer && isQtyPositive)) {
 indicatorColor = "text-green-600 bg-green-50 ";
 } else if (isSale || (isTransfer && !isQtyPositive)) {
 indicatorColor = "text-red-600 bg-red-50 ";
 }
 ...
 <Text className="text-sm text-on-surface-variant mt-1 font-semibold">
 ...
 className="bg-surface text-on-surface border border-gray-200 rounded-xl px-4 py-4 font-bold text-3xl text-center tracking-widest mb-4"
 />
 ...
 maxLength={4}
 keyboardType="number-pad"
 className="bg-surface text-on-surface border border-gray-200 rounded-xl px-4 py-4 font-bold text-3xl text-center tracking-widest mb-6"
 />
 ...
 {roles.length === 0 ? (
 <Text className="text-on-surface-variant italic">Loading roles... (Requires Admin permissions)</Text>
 ) : (
 roles.map(r => (
 <Pressable
 key={r.id}
 ...
 <Text
 className={`font-bold ${
 newStaffRole === r.id ? "text-white" : "text-on-surface "
 }`}
 >
 {r.name}
 </Text>
 ...
 !newStaffRole ? "bg-gray-400" : "bg-primary "
 }`}
 >
 {addStaffLoading ? (
 <ActivityIndicator color="white" />
 ...
 {staff.length === 0 ? (
 <Text className="text-on-surface-variant italic">No staff found. Create an employee first.</Text>
 ) : (
 <View className="flex-row flex-wrap mt-2">
 {staff.map(s => (
 <Pressable
 ...
 <Text
 className={`font-bold ${
 taskAssignedTo === s.id ? "text-white" : "text-on-surface "
 }`}
 >
 {s.first_name} {s.last_name || ""}
 </Text>
 ...
 className={`py-4 px-6 rounded-xl w-[48%] items-center ${
 !taskAssignedTo ? "bg-gray-400" : "bg-primary "
 }`}
 >
 {dispatchLoading ? (
 <ActivityIndicator color="white" />
 ...
 <View className="bg-white rounded-t-3xl px-6 pb-10" style={{ paddingTop: 24, maxHeight: "70%" }}>
 ...
 <ActivityIndicator size="small" color={theme.colors.primary} />
 <Text className="text-sm text-on-surface-variant mt-3">Loading outlets...</Text>
 </View>
 ) : (
 ...
 <Text className={`text-base font-bold ${isActive ? "text-primary" : "text-on-surface "}`}>
 {o.name}
 </Text>
 ...
 className="mt-4 py-3 rounded-xl items-center border border-gray-200 "
 >
